...
class GridOpsEnvironment(Environment):
    ...
    def _make_observation(self, reward: float, done: bool, narration: str) -> GridOpsObservation:
        ...
        return GridOpsObservation(
            ...
            demand_forecast_24h=make_forecast(self._demand, h, 24, self._cfg.forecast_noise, rng, grow_noise=True),
            solar_forecast_24h=make_forecast(self._solar, h, 24, self._cfg.forecast_noise, rng, grow_noise=True),
            price_forecast_24h=make_forecast(self._price, h, 24, self._cfg.forecast_noise, rng, grow_noise=True),
