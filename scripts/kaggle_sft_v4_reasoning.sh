...
export GRIDOPS_TRACE_PATH="${GRIDOPS_TRACE_PATH:-sft_traces/gridops_curriculum_v4_kimi_reason_action_500.jsonl}"
export GRIDOPS_RUN_LABEL="${GRIDOPS_RUN_LABEL:-sft_qwen25_3b_gridops_kimi_reason_action_v4}"
...
export GRIDOPS_SFT_STEPS="${GRIDOPS_SFT_STEPS:-300}"
