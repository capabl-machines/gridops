...
export GRIDOPS_TRACE_PATH="${GRIDOPS_TRACE_PATH:-sft_traces/gridops_curriculum_v51_crisis_repair.jsonl}"
export GRIDOPS_RUN_LABEL="${GRIDOPS_RUN_LABEL:-sft_qwen25_3b_gridops_v51_crisis_repair}"
...
export GRIDOPS_INIT_ADAPTER="${GRIDOPS_INIT_ADAPTER:-77ethers/gridops-models/sft_qwen25_3b_gridops_v5_causal_teacher}"

export GRIDOPS_SFT_STEPS="${GRIDOPS_SFT_STEPS:-70}"
...
export GRIDOPS_LEARNING_RATE="${GRIDOPS_LEARNING_RATE:-3e-5}"
export GRIDOPS_GRADIENT_CHECKPOINTING="${GRIDOPS_GRADIENT_CHECKPOINTING:-1}"
export GRIDOPS_UPLOAD="${GRIDOPS_UPLOAD:-1}"

python scripts/build_gridops_v51_crisis_repair_traces.py
