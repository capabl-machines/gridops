...
export GRIDOPS_TRACE_PATH="${GRIDOPS_TRACE_PATH:-sft_traces/gridops_curriculum_v5_causal_teacher.jsonl}"
export GRIDOPS_RUN_LABEL="${GRIDOPS_RUN_LABEL:-sft_qwen25_3b_gridops_v5_causal_teacher}"
...
export GRIDOPS_SFT_STEPS="${GRIDOPS_SFT_STEPS:-175}"
...
export GRIDOPS_LEARNING_RATE="${GRIDOPS_LEARNING_RATE:-6e-5}"
export GRIDOPS_GRADIENT_CHECKPOINTING="${GRIDOPS_GRADIENT_CHECKPOINTING:-1}"
export GRIDOPS_UPLOAD="${GRIDOPS_UPLOAD:-1}"

export GRIDOPS_V5_SEEDS_PER_TASK="${GRIDOPS_V5_SEEDS_PER_TASK:-12}"
export GRIDOPS_V5_SEED_START="${GRIDOPS_V5_SEED_START:-16000}"
export GRIDOPS_V5_HORIZON="${GRIDOPS_V5_HORIZON:-12}"
export GRIDOPS_V5_STRIDE="${GRIDOPS_V5_STRIDE:-1}"
export GRIDOPS_V5_BASE_TRACE="${GRIDOPS_V5_BASE_TRACE:-sft_traces/gridops_curriculum_v4_kimi_reason_action_500.jsonl}"
export GRIDOPS_V5_BASE_SAMPLE_LIMIT="${GRIDOPS_V5_BASE_SAMPLE_LIMIT:-1800}"
